...
1. 실제 workload 6건의 승인된 child decomposition/grant와 source-e/f dependency lock·read-only cache fixture를 확보해 v4 후보를 생성한 뒤 exact Git registry record·외부 RFC 3161 registration receipt를 확보한다.
