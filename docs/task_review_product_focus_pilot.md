...
revision 6는 calibration에서 자유서술 문구가 아닌 구조화 판정만 비교하고 fixture에 정답 boundary를 노출하지 않는다. 또한 네 authority의 정보 접근 경계, T0 전 표본 제외 protocol rehearsal, `INCONCLUSIVE` 뒤 동일 study 연장·표본 합산 금지를 registration v3에 봉인한다.
