...
def _resolve_benchmark_policy_summary(
    *,
    ...
    return {
        ...
        "user_selection_needed": str(decision["user_selection_needed"]),
...
def _decision_from_summary(summary: dict[str, object]) -> dict[str, object]:
    ...
    return {
        ...
        "user_selection_needed": policy_summary["user_selection_needed"],
...
def build_expensive_flow_report(
    ...
    explanation_lines = _build_operator_explanation_lines(
        dominant_flow_kind=dominant_flow_kind,
        flow_kind_counts=flow_kind_counts,
        observed_reason_signal_counts=observed_reason_signal_counts,
